...
\guideline{Brief description of the main points of the dataset card, and link to the file in the repository.}

\subsubsection{Model card}
\guideline{Brief description of the main points of the model card, and link to the file in the repository.}
